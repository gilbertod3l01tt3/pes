...
/**
 * Modelo para generar CRUD.
 * @author llopezmalo
 *
 */
public class PORTALBI_CONFIGREPORTEROL {
	 ...
	 * Constructor.
	 */
	public PORTALBI_CONFIGREPORTEROL() {
	 ...
	 * @param pagina
	 */
	public PORTALBI_CONFIGREPORTEROL(Long idRol, Long idReporte, String nombreDespliegue, int ordenDespliegue,
