...
<title>M&oacute;dulo de Administraci&oacute;n</title>
...
<body>
	<h1>A continuaci&oacute;n se presenta el m&oacute;dulo de administraci&oacute;n de reportes:</h1>	
	<div class="container">
	</br>
	</br>
	</br>
		<div class="row">
		  ...
		  <div class="col-xs-6 col-md-6">		    
		    <a href="configuracionreportes?accion=" class="btn btn-success btn-lg btn-block" role="button">Configurar Reportes</a>				
		  </div>
		</div>
		<div class="row">
		  <div class="col-xs-6 col-md-6">
